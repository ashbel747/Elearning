        ...
        {videoProgress[file.id] && (
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent p-4">
            <div className="flex items-center gap-2 text-white text-sm">
              <button onClick={togglePlay} className="hover:bg-white/20 p-1 rounded">
              ...
              <span>
                {Math.floor(videoProgress[file.id].currentTime || 0)}s / {Math.floor(videoProgress[file.id].duration || 0)}s
              </span>
            </div>
          </div>
        )}
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              {selectedFile ? (
                <div>
                  <div className="mb-6">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600">
                      <span>Type: {getFileType(selectedFile.type)}</span>
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500">Select a file from the left panel to preview it</p>
                </div>
              )}
            </div>
          </div>
