  ...
  return (
    <div className="pt-28">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <Link to={"/"}>
          <MetricsCard title="Course Progress" value={`$${data.totalRevenue}`} icon={<Badge />} />
        </Link>
      </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-yellow-100 dark:bg-gray-700 rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold mb-4 dark:text-white">Assessments</h2>
            <div className="flex items-center mb-4">
              <span className="mr-2 font-medium dark:text-white">29 submitted</span>
              <div className="flex-1 bg-gray-300 rounded-full h-2 relative">
                <div
                  className="bg-yellow-600 h-2 rounded-full"
                  style={{ width: `${(29 / (29 + 8)) * 100}%` }}
                ></div>
              </div>
              <span className="ml-2 font-medium dark:text-white">8 left</span>
            </div>
          ...
          {/* Top Learners Card */}
          <div className="bg-yellow-100 dark:bg-gray-700 rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold mb-4 dark:text-white">Top Learners</h2>
            <ul className="space-y-2 mb-4">
              <li className="flex justify-between items-center">
                <span className="dark:text-white">1. Mayweather Beckham</span>
                <span className="text-yellow-500 font-semibold">72pts</span>
              </li>
              <li className="flex justify-between items-center">
                <span className="dark:text-white">2. Mary Anna</span>
                <span className="text-gray-400 font-semibold">67pts</span>
              </li>
              <li className="flex justify-between items-center">
                <span className="dark:text-white">3. Noise Talerman</span>
                <span className="text-yellow-800 font-semibold">59pts</span>
              </li>
            </ul>
          ...
          {/* My Schedule Card */}
          <div className="bg-yellow-100 dark:bg-gray-700 rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold mb-4 dark:text-white">My Schedule</h2>
            <div className="flex space-x-2 mb-4">
              {["Mo 17","Tu 18","We 19","Th 20","Fr 21","Sa 22"].map((day, i) => (
                <div
                  key={i}
                  className={`px-3 py-1 rounded border ${
                    day === "We 19" ? "bg-black text-white" : "bg-yellow-200"
                  }`}
                >
                  {day}
                </div>
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="dark:text-white">Web Development - Introduction to TypeScript</li>
              <li className="dark:text-white">10:15AM - 12:45PM</li>
              <li className="dark:text-white">Assignment Grading: 2:00PM - 2:40PM</li>
              <li className="dark:text-white">Assignment Review: 3:50PM - 4:50PM</li>
            </ul>
          </div>

          {/*Uploads card */}
          <div className="bg-yellow-100 dark:bg-gray-700 rounded-2xl p-6 shadow-md flex flex-col items-center justify-center">
            <h2 className="text-3xl font-bold mb-6 dark:text-white tracking-wide">Uploads</h2>
