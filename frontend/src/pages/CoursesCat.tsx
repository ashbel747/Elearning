...
import { Search, Filter, Grid, List, Star, Clock, Users, Play, BookOpen, ChevronLeft, ChevronRight } from 'lucide-react';
...
const sampleInstructors: Instructor[] = [
  {
    id: '1',
    name: 'Sarah Johnson',
    bio: 'Full-stack developer with 10+ years of experience in React, Node.js, and cloud architecture.',
    ...
    lessons: [
      {
        ...
        duration: 45,
        resources: ['slides.pdf', 'starter-code.zip'],
        isCompleted: true,
        order: 1
      },
      {
    ...
    >
        ...
        {progress && (
          <div className="absolute bottom-0 left-0 right-0 bg-gray-900 bg-opacity-75 text-white p-2">
            <div className="flex justify-between text-sm">
              ...
              <span>{progress.completedLessons.length}/{course.lessons.length} Lessons</span>
            </div>
      ...
      <div className="p-4">
        <div className="flex items-center mb-2">
          ...
          <span className="ml-2 text-sm text-gray-600">{course.category}</span>
        </div>
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  <div className="text-xl font-bold text-blue-600 mb-1">{formatPrice(course.price)}</div>
                  {progress && (
                    <div className="text-sm text-green-600">{progress.progressPercentage}% Complete</div>
                  )}
                </div>
              </div>
            </div>
...
const CourseDetailPage: React.FC<{
  ...
  const handleTabClick = (tabKey: 'overview' | 'lessons' | 'instructor' | 'reviews') => {
    setActiveTab(tabKey);
  };
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex border-b mb-6">
            {[
              ...
              <button
                key={tab.key}
onClick={() => handleTabClick(tab.key as "overview" | "lessons" | "instructor" | "reviews")}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  ...
                  <div className="font-semibold">{course.enrollmentCount.toLocaleString()}</div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                    ...
                    <div>{course.instructor.coursesCount} Courses</div>
                  </div>
                  <p className="text-gray-700 mb-4">{course.instructor.bio}</p>
                  <div className="flex flex-wrap gap-2">
                    {course.instructor.specialties.map(specialty => (
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-4">
            <div className="text-3xl font-bold text-blue-600 mb-4">{formatPrice(course.price)}</div>
            ...
            <div className="mt-6 space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>{course.lastUpdated.toLocaleDateString()}</span>
              </div>
              <div className="flex justify-between">
                <span>Category:</span>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4">
                {relatedCourses.slice(0, 3).map(relatedCourse => (
                  <div key={relatedCourse.id} className="flex space-x-3 p-3 border border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                    <img 
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-600 mt-1">{relatedCourse.instructor.name}</div>
                      <div className="text-sm font-semibold text-blue-600">{formatPrice(relatedCourse.price)}</div>
                    </div>
                  </div>
                ))}
              </div>
...
// Main Component
const CourseCatalogSystem: React.FC = () => {
  ...
  useEffect(() => {
    const filtered = courses.filter(course => {
      ...
      const matchesInstructor = !filters.instructor || course.instructor.name === filters.instructor;
      
      const matchesDuration = !filters.duration || 
        (filters.duration === 'short' && course.duration < 600) ||
        (filters.duration === 'medium' && course.duration >= 600 && course.duration < 1800) ||
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6">
        <CourseDetailPage
          ...
          progress={progressData.find(p => p.courseId === selectedCourse.id)}
